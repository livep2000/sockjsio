...
exports.on = function( eventName , callback )    
	...
	_sockserver.on( eventName , function( connection )
		...
		var sendToClients = function(data, sendType )
        	...
        	connection.emitClient = function( data ) // send to all clients
                	{
			sendToClients(data , "emit");
                	};
		...
		var sendToRooms = function(roomName, data, sendType )
        	...
        	// send to all users in room including the sender
		connection.emitRoom = function (roomName, data )
			{
			sendToRooms(roomName, data, "emit"); 
 			};
